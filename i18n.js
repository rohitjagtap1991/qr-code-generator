...
const translations = {
    en: {
        ...
        feature1Title: "📱 Multiple QR Types",
        feature1Desc: "Generate QR codes for WiFi networks, vCard contacts, emails, phone numbers, SMS, and plain text/URLs.",
        feature2Title: "💯 100% Free",
        feature2Desc: "No signup, no watermarks, no limitations. Completely free forever.",
        feature3Title: "🔒 Privacy First",
        feature3Desc: "All processing happens in your browser. No data is sent to any server.",
        feature4Title: "📋 Copy to Clipboard",
        feature4Desc: "Instantly copy generated QR codes to clipboard for quick sharing and pasting.",
        feature5Title: "⚡ Instant Generation",
        feature5Desc: "Create QR codes in seconds with real-time preview and dynamic error correction.",
        feature6Title: "🎨 Customizable Colors",
        feature6Desc: "Choose any foreground and background colors with hex input to match your brand.",
        feature7Title: "🖼️ High Resolution",
        feature7Desc: "Download QR codes up to 2048x2048 pixels with ISO standard quiet zones for print quality.",
        feature8Title: "💾 Multiple Formats",
        feature8Desc: "Download as PNG for images or SVG for scalable vector graphics with smart filenames.",
        feature9Title: "🌍 Multilingual Support",
        feature9Desc: "Full interface available in English and Spanish with instant language switching.",
        feature10Title: "📥 Download History",
        feature10Desc: "Track your recently generated QR codes with preview thumbnails for quick access.",
    ...
    es: {
        ...
        feature1Title: "📱 Múltiples Tipos de QR",
        feature1Desc: "Genera códigos QR para redes WiFi, contactos vCard, correos electrónicos, números de teléfono, SMS y texto/URLs.",
        feature2Title: "💯 100% Gratis",
        feature2Desc: "Sin registro, sin marcas de agua, sin limitaciones. Completamente gratis para siempre.",
        feature3Title: "🔒 Privacidad Primero",
        feature3Desc: "Todo el procesamiento ocurre en tu navegador. No se envían datos a ningún servidor.",
        feature4Title: "📋 Copiar al Portapapeles",
        feature4Desc: "Copia instantáneamente códigos QR generados al portapapeles para compartir y pegar rápidamente.",
        feature5Title: "⚡ Generación Instantánea",
        feature5Desc: "Crea códigos QR en segundos con vista previa en tiempo real y corrección de errores dinámica.",
        feature6Title: "🎨 Colores Personalizables",
        feature6Desc: "Elige cualquier color principal y de fondo con entrada hexadecimal para que coincida con tu marca.",
        feature7Title: "🖼️ Alta Resolución",
        feature7Desc: "Descarga códigos QR de hasta 2048x2048 píxeles con zonas de silencio estándar ISO para calidad de impresión.",
        feature8Title: "💾 Múltiples Formatos",
        feature8Desc: "Descarga como PNG para imágenes o SVG para gráficos vectoriales escalables con nombres de archivo inteligentes.",
        feature9Title: "🌍 Soporte Multilingüe",
        feature9Desc: "Interfaz completa disponible en inglés y español con cambio de idioma instantáneo.",
        feature10Title: "📥 Historial de Descargas",
        feature10Desc: "Rastrea tus códigos QR generados recientemente con miniaturas de vista previa para acceso rápido.",
